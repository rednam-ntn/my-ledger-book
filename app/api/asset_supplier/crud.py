...
from app.db.models.asset_supplier import AssetSupplier
from app.schemas.asset_supplier import AssetSupplierCreate, AssetSupplierUpdate


class CRUDAssetSupplier(CRUD[AssetSupplier, AssetSupplierCreate, AssetSupplierUpdate]):
    ...
    # TODO
...
crud_asset_supplier = CRUDAssetSupplier(AssetSupplier)
